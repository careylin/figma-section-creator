...
function tryLoadingFont(fontName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield figma.loadFontAsync({ family: "Manrope", style: "Regular" });
            return fontName;
        }
        catch (error) {
...
function runMyPlugin(keyword, sectionNames) {
    return __awaiter(this, void 0, void 0, function* () {
        yield tryLoadingFont({ family: "Manrope", style: "Regular" });
        ...
        for (let i = 0; i < numberOfSections; i++) {
            ...
            let c = yield figma.importComponentByKeyAsync(componentKey);
